# -*- coding: utf-8 -*-
"""
Created on Wed Aug 28 14:22:32 2024
...
window=tk.Tk()
# frame_left=tk.Frame(window,width=540,height=640,bg="blue")
...
frame2=ttk.Frame(pw,width=720,height=400,relief=tk.RIDGE)#relief->çerçeve tasarımı
