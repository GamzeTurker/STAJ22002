# -*- coding: utf-8 -*-
"""
Created on Wed Aug 28 12:39:06 2024
...
# cyan.pack(side=tk.TOP,fill=tk.BOTH,expand=True)#fill->yatayda genişletir  expand->dikeyde genişletir
...
label4.place(relx=0.5,rely=0.5)#•oran belirleriz
window.mainloop()